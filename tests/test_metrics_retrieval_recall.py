...
class TestTheJudgeIsPinned:
    ...
    Before this, `measure_retrieval_recall` passed no `model_name`, so
    ...
    RESPONSE = {
        "coverage": [
            {"topic": "alpha", "covered": True, "paper_ids": [], "reason": "ok"}
        ]
    }

    def _score(self) -> None:
        measure_retrieval_recall([_mk_paper("p1", "Paper A", "about alpha")], ["alpha"])
